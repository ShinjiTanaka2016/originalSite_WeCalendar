...
<%
ScheduleBeans sb = (ScheduleBeans)request.getAttribute("plandata");
%>
...
<body>
	...
	<tr><td>グループ</td><td>:<%= sb.getCreateGroup() %></td><tr>
	<tr><td>作成者</td><td>:<%= sb.getCreateUser() %></td><tr>
	</table>

	<br>
	<form action="/WeCalendar/AddGroupScheduleComplete" method="post">
