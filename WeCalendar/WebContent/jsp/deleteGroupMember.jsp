...
String member = wcDAO.displayGroupMember(gB.getGroupId());
%>
...
<body>
	...
	<% }else{ %>
		<div class="container">
		<b>【<%= groupName %>】　member</b><br>
		<%= member %><br>

	    <form action="/WeCalendar/DeleteGroupMenberCheck" method="post" class="form-horizontal">
	    <label>削除したいメンバーのユーザIDを入力して下さい。</label><br>
	    <label style="color:red;font-size:12px;" >※　グループ管理者は削除できません。</label>
